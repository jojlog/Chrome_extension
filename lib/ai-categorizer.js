    ...
    const response = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: 'You are a strict categorization assistant. your primary goal is to use EXISTING categories. Only create new ones if absolutely necessary. Always respond with valid JSON arrays only.'
          },
          {
            role: 'user',
            content: prompt
